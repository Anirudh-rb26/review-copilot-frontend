...
export default function Home() {
  ...
  const activeReviews = uploadedReviews.length > 0 ? uploadedReviews : showMockData ? mockReviews : [];
  const locations = ["All Locations", ...new Set(activeReviews.map(review => review.location))];
  ...
  return (
    <div className="px-6">
      ...
      {
        !baseReview || baseReview?.length === 0 ? (
          <div className="flex flex-col gap-5 mt-10 items-center justify-center">
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-md mt-1">Upload your JSON or use MockData</p>
            </div>
            <Button
              variant="outline"
...

            {
              filteredReviews.length === 0 ? (
                <div className="flex flex-col gap-5 mt-10 items-center justify-center">
                  <div className="flex flex-col items-center justify-center">
                    <h1 className="text-3xl">No Reviews Available!</h1>
                    <p className="text-md mt-1">Try adjusting your filters</p>
                  </div>
                </div>
              ) : (
                <ReviewTable
